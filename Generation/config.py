...
data_root_h5 = "train_h5"

parser = argparse.ArgumentParser()
parser.add_argument('--phase', type=str, default='train', help='train or test ?')
parser.add_argument('--workers', type=int, default=4, help='number of data loading workers')
parser.add_argument('--bs', type=int, default=32, help='input batch size [default: 30]')
parser.add_argument('--np', type=int, default=1024, help='Point Number [256/512/1024/2048] [default: 1024]')
